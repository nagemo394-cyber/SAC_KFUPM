...
export default function CouncilStructure({ t, lang = 'ar' }) {
    ...
    const committees = [
        {
            ...
            color: "#00733E",
            leader: { name: "عبدالله السيف", email: "s202372410@kfupm.edu.sa", major: "المالية" },
            teams: [
                {
        ...
        },
        {
            ...
            color: "#FF9900",
            leader: { name: "منيرة الدوسري", email: "s202257120@kfupm.edu.sa", major: "الهندسة الكيميائية" },
            members: [
                ...
                { name: "عمر نجم", major: "هندسة الطيران والفضاء", email: "s202345270@kfupm.edu.sa" }
            ]
        },
        {
            id: 3,
    ...
    const MemberCard = ({ member, index, isLeader, role, commitColor, isFemaleLeader }) => {
            ...
            >
                ...
                {(isLeader || member.role) && (
                    <div style={{
                        ...
                        {isLeader ? (lang === 'ar' ? (isFemaleLeader ? 'القائدة' : 'القائد') : 'LEADER') : getMajor(member.role)}
                    </div>
                )}
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <MemberCard
                            ...
                            index="pres"
                            isLeader={true}
                            role={lang === 'ar' ? 'قائد المجلس' : 'PRESIDENT'}
                            commitColor="#00733E"
                        />
                        <MemberCard
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                <MemberCard
                                    ...
                                    isFemaleLeader={committee.id === 2 || committee.id === 3}
                                />
                            </div>
